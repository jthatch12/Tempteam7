...
SAMPLE_ECHO_DELAY:
	...
	//
	//
	// if roundtrip goes past MAX_COUNT, fall through
	// you need 58.44 us for 1 cm - sensor has a 350 cm max
	// 350 * 58.44	= 14610 us for MAX_COUNT time out
	// 100 loops = 1 us
	// then 1461000 loops for timeout
	//
	
	//CHANGE TO BRANCH IF EQUAL
	QBEQ ECHO_COMPLETE, roundtrip, r5
